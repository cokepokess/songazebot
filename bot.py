...
Bot = Client(
    "Song Downloader Bot",
    bot_token = os.environ["5083210468:AAGSq0y9iDPSHYFSJDcsUafscg2JWp0DvJk"],
    api_id = int(os.environ["10908371"]),
    api_hash = os.environ["fb95c19178dff8e5be224a79261cd19c"]
)

db = Database()

START_TEXT = """ `Hai {}, 
Bu Bot YouTube-dan Mahnıları, Videoları və Telegram-a yükləyir. 
...
ABOUT_TEXT = """
- **Bot :** `Musiqi_botu`
- **Creator :** [cokepokess](https:www,instagram.com/cokepokesss)
- **Support :** [CLICK HERE](https://telegram.me/cokepokess)
- **Source :** [CLICK HERE](https://github.com/cokepokess)
